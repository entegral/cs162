...
void SongList::displayLibrary(Song songs[], int &size)
{
	cout << "**************************" << endl;
...
void SongList::addToLibrary(Song songs[], int &size)							// parameters needed: 	the array to add to AND the current size of it
